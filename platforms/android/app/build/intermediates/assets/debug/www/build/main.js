...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_leaflet__ = __webpack_require__(268);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, platform) {
        ...
        this.marker = new __WEBPACK_IMPORTED_MODULE_2_leaflet___default.a.Marker(this.center, {
            title: 'Teste'
        });
    }
    ...
    HomePage.prototype.leafletMap = function () {
        ...
        var position = __WEBPACK_IMPORTED_MODULE_2_leaflet___default.a.tileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    ...
    HomePage.prototype.fabClickDois = function (event) {
        this.map.addLayer(this.marker);
    };
    HomePage = __decorate([
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\mapbox-test\mapbox-test\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\mapbox-test\mapbox-test\src\app\app.html"*/
        }),
